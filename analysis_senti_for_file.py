...
def gpt_analysis(base_index, def_index, prompt_index, text):
    ...
    # response = llm.get_completion_from_pmt_with_big_turbo(prompt)
    response = llm.get_completion_from_pmt_with_turbo(prompt)
...
def analysis_for_file():
    ...
    for i in range(len(text_need_res_list)):
        ...
        senti = gpt_analysis(base_index, def_index, prompt_index,
                             text_need_res)
